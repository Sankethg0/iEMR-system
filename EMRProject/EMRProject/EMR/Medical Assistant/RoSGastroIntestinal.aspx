<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Medical Assistant/RoSGastroIntestinal.aspx.cs" Inherits="EMR.RoSGastroIntestinal" %>
    ...
    <div class="tablediv" align="center">
        ...
        <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label1" runat="server" Text="Label"> <b>ABDOMINAL PAIN </b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label2" runat="server" Text="Label"> <b>VOMITING </b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label4" runat="server" Text="Label"> <b>CHANGE IN APITITE </b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label3" runat="server" Text="Label"> <b>DYSPEPSIA </b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label5" runat="server" Text="Label"> <b>BLACK OR TARRY STOOLS</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label6" runat="server" Text="Label"> <b>CONSTIPATION</b></asp:Label>
              ...
              <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label7" runat="server" Text="Label"> <b>FREQUENT DIARRHEA</b></asp:Label>
              ...
              <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label8" runat="server" Text="Label"> <b>VOMITING OF BLOOD</b></asp:Label>
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label9" runat="server" Text="Label"> <b>BLOTTING</b></asp:Label>
              ...
              <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label10" runat="server" Text="Label"> <b>BLOOD IN STOOLS</b></asp:Label>
      ...
      <div class="centerblock" align="center">
            ...
            <br />
                      <div class="centerblock" align="center">
                      <asp:Label ID="Label11" runat="server" Text="Label" ><a  href="javascript:history.back(-1);"><b>Go Back</b></a></asp:Label> 
 
                     </div>
        <asp:TextBox ID="txtgastro" runat="server" TextMode="MultiLine" Visible="false" ></asp:TextBox>
</asp:Content>
