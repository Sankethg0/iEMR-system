<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Medical Assistant/RoSEndocrine.aspx.cs" Inherits="EMR.RoSEndocrine" %>
    ...
    <div class="tablediv" align="center">
        ...
        <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label1" runat="server" Text="Label"> <b>FATIGUE</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label2" runat="server" Text="Label"> <b>COLD INTOLERANCE</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label4" runat="server" Text="Label"> <b>INCREASED THIRST</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label3" runat="server" Text="Label"> <b>HAIR LOSS</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label5" runat="server" Text="Label"> <b>THYROID SWELLING</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label6" runat="server" Text="Label"> <b>VITILIGO</b></asp:Label>
      ...
      <div class="centerblock" align="center">
        ...
        <asp:TextBox ID="txtEnd" runat="server" TextMode="MultiLine" Visible="false" ></asp:TextBox>
</asp:Content>
