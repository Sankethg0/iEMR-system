<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Medical Assistant/RoSNeurologic.aspx.cs" Inherits="EMR.RoSNeurologic" %>
    ...
    <div class="tablediv" align="center">
        ...
        <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label1" runat="server" Text="Label"> <b>NUMBNESS</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label2" runat="server" Text="Label"> <b> SEIZURES</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label4" runat="server" Text="Label"> <b>MIGRAIN</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label3" runat="server" Text="Label"> <b>RESTRLESS LEGS</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label5" runat="server" Text="Label"> <b>FREQUENT ORSEVERE HEDACHES</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label6" runat="server" Text="Label"> <b>DIZZINESS</b></asp:Label>
              ...
              <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label7" runat="server" Text="Label"> <b>LOSS OF CONCIOUSNESS</b></asp:Label>
              ...
              <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label8" runat="server" Text="Label"> <b>WEAKNESS</b></asp:Label>
      ...
      <div class="centerblock" align="center">
        ...
        <asp:TextBox ID="txtNeu" runat="server" TextMode="MultiLine" Visible="false" ></asp:TextBox>
</asp:Content>
