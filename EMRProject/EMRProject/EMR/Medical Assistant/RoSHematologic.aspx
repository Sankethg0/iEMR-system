<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Medical Assistant/RoSHematologic.aspx.cs" Inherits="EMR.RoSHematologic" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  background-color: red;
     ...
     <div class="heading">
        <h3 align="center"><b>HEMATOLOGIC/LYMPHATIC</b></h3>
    </div>
    <div class="space"> </div>
    ...
    <div class="tablediv" align="center">
        ...
        <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label1" runat="server" Text="Label"> <b>EASY BRUSING</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label2" runat="server" Text="Label"> <b>SWOLLEN GLANDS</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label4" runat="server" Text="Label"> <b>EXCESSIVE BLEEDING</b></asp:Label>
      ...
      <div class="centerblock" align="center">
        ...
        <asp:TextBox ID="txtHema" runat="server" TextMode="MultiLine" Visible="false" ></asp:TextBox>
</asp:Content>
