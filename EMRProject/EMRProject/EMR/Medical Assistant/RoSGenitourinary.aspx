<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Medical Assistant/RoSGenitourinary.aspx.cs" Inherits="EMR.RoSGenitourinary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  background-color: red;
     ...
     <div class="heading">
        <h3 align="center"><b>GENITOURINARY</b></h3></div>
    <div class="space"> </div>
    ...
    <div class="tablediv" align="center">
        ...
        <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label1" runat="server" Text="Label"> <b>URINARY LOSS OF CONTROL</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label2" runat="server" Text="Label"> <b>DIFFICULTY OF URINATING</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label3" runat="server" Text="Label"> <b>INCREASED URINARY FREQUENCY</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label4" runat="server" Text="Label"> <b>HEMATURIA ( BLLOD IN URINE)</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label5" runat="server" Text="Label"> <b>INCOMPLETE EMPTYING</b></asp:Label>
      ...
      <div class="centerblock" align="center">
        ...
        <asp:TextBox ID="txtGeni" runat="server" TextMode="MultiLine" Visible="false" ></asp:TextBox>
</asp:Content>
