<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Medical Assistant/RoSPsychiatric.aspx.cs" Inherits="EMR.RoSPsychiatric" %>
    ...
    <div class="tablediv" align="center">
        ...
        <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label1" runat="server" Text="Label"> <b>DEPRESSION</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label2" runat="server" Text="Label"> <b>ALCOHOL ABUSE</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label4" runat="server" Text="Label"> <b>SLEEP DISTURBANCES</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label3" runat="server" Text="Label"> <b>RESTLESS SLEEP</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label5" runat="server" Text="Label"> <b>ANXIETY</b></asp:Label>
             ...
             <tr align="left">
                ...
                <td height="30px" width="450px" style="background-color:yellow">
                    <asp:Label ID="Label6" runat="server" Text="Label"> <b>PHOBIAS</b></asp:Label>
      ...
      <div class="centerblock" align="center">
        ...
        <asp:TextBox ID="txtPsy" runat="server" TextMode="MultiLine" Visible="false" ></asp:TextBox>
</asp:Content>
