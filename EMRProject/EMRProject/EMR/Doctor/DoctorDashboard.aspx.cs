...
namespace EMR
{
    ...
    {
        private static readonly string conn = System.Configuration.ConfigurationManager.ConnectionStrings["con"].ConnectionString;
            ...
            try
            {
                if (txtRBDoctor.Text.Length > 4)
                {
                    ...
                    if (txtRBDoctor.Text.Length == 3)
                    {
                        ...
                        if (key2 == "PMH")
                        {
                            Response.Redirect("../Medical Assistant/PastMedicalHistory.aspx");
                        }
                        else if (key2 == "ALL")
                        {
                            Response.Redirect("../Medical Assistant/Allergy.aspx");
                        }
                        else if (key2 == "IMG")
                        {
                            Response.Redirect("../Medical Assistant/Image.aspx");
                        }
                        else if (key2 == "ROS")
                        {
                    ...
                    if (txtRBDoctor.Text.Length == 4)
                    {
                        ...
                        if (key4 == "PTED")
                        {
                            Response.Redirect("../Medical Assistant/PatientEducation.aspx");
                        }
                    }
                    if (txtRBDoctor.Text.Length == 5)
                    {
                        ...
                        {
                            Response.Redirect("../Medical Assistant/90DaySnap.aspx");
                        }
                    ...
                    if (txtRBDoctor.Text.Length == 2)
                    {
                        ...
                        if (key1 == "FH")
                        {
                            Response.Redirect("../Medical Assistant/FamilyHistory.aspx");
                        }
                        else if (key1 == "CM")
                        {
                            Response.Redirect("../Medical Assistant/CurrentMedications.aspx");
                        }
                        else if (key1 == "PI")
                        {
                            Response.Redirect("../Medical Assistant/PresentIllness.aspx");
                        }
                        else if (key1 == "SH")
                        {
                            Response.Redirect("../Medical Assistant/SocialHistory.aspx");
                        }
                        else if (key1 == "LR")
                        {
