...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="centerblock" align="center">
    ...
    <p style="width: 400px;">
        <script type="text/javascript">
            var idArray = ["txtUser", "txtPass", "Button1"];
    ...
    <asp:TextBox ID="txtUser" runat="server" Width="300px" autocomplete="off" onkeydown="focusNext(e)"></asp:TextBox>
    </p>
    <br />
   ...
   <p style="width: 400px;">
    ...
    <asp:TextBox ID="txtPass" runat="server" Width="300px" autocomplete="off" TextMode="Password" onkeydown="focusNext(e)"></asp:TextBox>
    </p>
        <br />
        <p style="width: 300px;">
            ...
            <asp:Button ID="Button1" class="btn btn-primary btn-lg" runat="server" Text="LOGIN" Width="115px" OnClick="Button1_Click" onkeydown="focusNext(e)"/>
    </p>
    <br />
         <p style="width: 300px;">
