...
namespace EMR
{
    public partial class Cough : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Dry | ";
            }
            if (CheckBox2.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + "Producing phlegm or sputum | ";
            }
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Trigged or worsened by- Allergens or irritants | ";
            }
            if (CheckBox7.Checked == true || CheckBox8.Checked == true || CheckBox9.Checked == true || CheckBox10.Checked == true || CheckBox11.Checked == true || CheckBox12.Checked == true || CheckBox13.Checked == true || CheckBox14.Checked == true || CheckBox15.Checked == true || CheckBox16.Checked == true || CheckBox17.Checked == true || CheckBox18.Checked == true || CheckBox19.Checked == true || CheckBox20.Checked == true || CheckBox21.Checked == true)
            {
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Hoarse voice | ";
            }
            ...
            if (CheckBox15.Checked == true)
            {
                ...
                {
                    txtAbdom.Text = txtAbdom.Text + "Watery or ichy eyes | ";
                }
