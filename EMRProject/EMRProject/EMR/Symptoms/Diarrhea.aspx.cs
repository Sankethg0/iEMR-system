...
namespace EMR
{
    public partial class Diarrhea : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Ongoing or recurrent (weeks to years) | ";
            }
            if (CheckBox2.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + "Recent (days to weeks) | ";
            }
            if (CheckBox3.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + "Sudden (hours to days) | ";
            }
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Relieved by- Avoiding certain foods,";
            }
            if (CheckBox6.Checked == true || CheckBox7.Checked == true || CheckBox8.Checked == true || CheckBox9.Checked == true || CheckBox10.Checked == true || CheckBox11.Checked == true || CheckBox12.Checked == true || CheckBox13.Checked == true || CheckBox14.Checked == true || CheckBox15.Checked == true || CheckBox16.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + " Accompanied by- ";
            }
            if (CheckBox6.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + "Abdominal pain or cramping | ";
            }
            if (CheckBox7.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + "Bloating or abdominal swelling | ";
            }
            if (CheckBox8.Checked == true)
            {
                txtAbdom.Text = txtAbdom.Text + "Bloody stools | ";
            }
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Mucus in stools | ";
            }
            ...
            {
                txtAbdom.Text = txtAbdom.Text + "Urgency to have a bowel movement | ";
            }
        }
